    ...
    <main className="hz-wa-page hz-wa-page--desk">
      <header className="hz-wa-desk-head">
        ...
        <div className="hz-wa-desk-head__actions">
          ...
          <button type="button" className="hz-wa-desk-btn" onClick={() => pushToast("Şablon gönderimi onay zincirinden geçer.")}>
      ...
      <div className="hz-wa-desk-grid">
        ...
        <WhatsAppDeskPreview
          ...
          onSelectTemplate={() => pushToast("Şablon seçimi onay sonrası uygulanır.")}
