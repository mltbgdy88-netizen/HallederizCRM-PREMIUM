  ...
  "siparise-donusturme": {
    ...
    buildRows: (id) => [
      ...
      invRow({
        ...
        description: "Execution dispatcher olmadan mutation çalışmaz."
      })
    ]
  },
  belgeler: {
    ...
    buildRows: (id) => [
      ...
      invRow({
        ...
        description: "Excel export API hazır olana kadar disabled."
      }),
      invRow({
        id: "whatsapp-doc",
  ...
  timeline: {
    ...
    buildRows: (id) => [
      ...
      invRow({
        ...
        description: "Follow-up görevleri görev merkezi ile bağlanır.",
        navHref: "/gorevler"
      }),
      invRow({
        id: "approval-events",
