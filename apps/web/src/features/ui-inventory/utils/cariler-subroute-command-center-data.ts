  ...
  ozet: {
    ...
    buildRows: (id) => [
      ...
      invRow({
        ...
        navHref: `/hizli-islem/satis-masasi?tab=order&customer=${id}`
      }),
      invRow({
        id: "demo-guard",
  ...
  teklifler: {
    ...
    buildRows: (id) => [
      ...
      invRow({
        ...
        sourceRoute: customerHref(id, "/teklifler"),
        readinessChips: ["PDF", "Excel"],
        description: "Dışa aktarma API hazır olana kadar kapalı."
      })
    ]
  },
  siparisler: {
    ...
    buildRows: (id) => [
      ...
      invRow({
        ...
        navHref: `/hizli-islem/satis-masasi?tab=delivery&customer=${id}`
      }),
      invRow({
        id: "new-order",
        title: "Yeni sipariş",
