...
export const PANEL_NAV_TARGETS = [
  ...
  { href: "/hizli-islem/satis-masasi", label: "Hızlı İşlem" },
...
export const PANEL_READINESS_DIMENSIONS = [
  ...
  { key: "audit", label: "Denetim izi", ready: false, hint: "Panel aksiyon izi" },
  { key: "export", label: "Dışa aktar", ready: false, hint: "Devre dışı" }
] as const;
