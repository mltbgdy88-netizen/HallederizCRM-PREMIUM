...
> = {
  ozet: {
    ...
    buildRows: (id) => [
      ...
      invRow({
        ...
        navHref: "/hizli-islem/satis-masasi?tab=order"
      }),
      invRow({
        id: "demo-guard",
  ...
  teslimat: {
    ...
    buildRows: (id) => [
      ...
      invRow({
        ...
        navHref: "/hizli-islem/satis-masasi?tab=delivery"
      }),
      invRow({
        id: "document",
  ...
  iade: {
    ...
    buildRows: (id) => [
      ...
      invRow({
        ...
        navHref: "/hizli-islem/satis-masasi?tab=return"
      })
    ]
  },
  "depo-stok-etkisi": {
  ...
  timeline: {
    ...
    title: "Sipariş zaman akışı",
    subtitle: "Sipariş zaman akışı katmanını denetim izi ve hazırlık sözleşmesi ile yönetin.",
