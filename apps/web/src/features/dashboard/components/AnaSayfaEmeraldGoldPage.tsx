...
import {
  ...
  EG_TASKS,
  EG_USER
} from "@/features/dashboard/data/ana-sayfa-emerald-gold-mock";
  ...
  return (
    <div className="eg-home">
      <p className="eg-welcome">
        Hoş geldiniz, <strong>{EG_USER.name}</strong>
      </p>

      <section className="eg-alerts" aria-label="Özet kartları">
        {EG_ALERTS.map((card) => (
      ...
      <section className="eg-mid-row">
        ...
        <article className="eg-panel eg-panel--ai">
          ...
          <div className="eg-ai-input-row">
            <input type="text" placeholder="Sorunuzu yazın..." readOnly aria-label="AI soru" />
            <button type="button" className="eg-ai-send" aria-label="Gönder">
              →
            </button>
          </div>
        </article>
      ...
      <section className="eg-bottom-row">
        ...
        <article className="eg-promo">
          ...
          <div className="eg-promo-copy">
            <span className="eg-promo-brand">HALLEDERİZ CRM PREMIUM</span>
            <strong>Daha Akıllı Yönetim, Daha Güçlü İş Sonuçları</strong>
      ...
      <footer className="eg-quickbar" aria-label="Hızlı işlemler">
