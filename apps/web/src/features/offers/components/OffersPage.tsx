...
export function OffersPage() {
  ...
  return (
    <main className="hz-offers-page hz-offers-page--desk hz-commercial-desk-standard">
      <div className="hz-offers-desk-shell hz-commercial-desk-shell">
        <header className="hz-offers-desk-head hz-commercial-desk-header">
          ...
          <div className="hz-offers-desk-head__actions">
            ...
            <button type="button" className="hz-offers-desk-btn" onClick={() => router.push("/hizli-islem/satis-masasi")}>
        ...
        <section className="hz-offers-desk-stats hz-commercial-desk-kpis" aria-label="Teklif özetleri">
          <article>
        ...
        {dataSourceConfig.useDemoData ? (
          <p className="hz-offers-preview-band hz-commercial-preview-band" role="status">
            Örnek veri modu: liste kayıtları demo amaçlıdır.
          </p>
        ) : null}

        <div className="hz-offers-desk-body hz-commercial-desk-body">
          <section className="hz-offers-desk-main hz-commercial-desk-main hz-commercial-desk-card">
          ...
          <aside className="hz-offers-desk-side hz-commercial-desk-side">
