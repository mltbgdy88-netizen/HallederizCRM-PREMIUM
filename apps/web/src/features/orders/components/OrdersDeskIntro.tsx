...
export function OrdersDeskIntro() {
  return (
    <header className="hz-orders-intro hz-orders-desk-head hz-commercial-desk-header">
      ...
      <div className="hz-orders-intro__actions">
        <Link href="/hizli-islem/satis-masasi" className="hz-orders-intro-btn hz-orders-intro-btn--primary">
          <LucideIcon name="plus-square" size={14} />
          <span>Yeni Sipariş</span>
        </Link>
        <Link href="/hizli-islem/satis-masasi" className="hz-orders-intro-btn hz-orders-intro-btn--secondary">
