...
import { ApprovalCommandIntro } from "./ApprovalCommandIntro";
import { ApprovalInboxEmpty, ApprovalInboxError, ApprovalInboxLoading } from "./ApprovalInboxStates";
import { ApprovalPolicyBand } from "./ApprovalPolicyBand";
    ...
    <main className="hz-approvals-page hz-approvals-command" aria-live="polite">
      <div className="hz-approvals-command__top">
        <ApprovalCommandIntro
          ...
          onSearchFocus={() => document.getElementById("hz-approval-queue-search")?.focus()}
        />
        <ApprovalPolicyBand />
        <ApprovalStatsStrip stats={stats} />
        {dataSourceConfig.useDemoData ? (
          <p className="hz-approval-preview-band" role="status">
            {MSG_APPROVAL_DEMO_BAND}
          </p>
        ) : null}
      </div>
