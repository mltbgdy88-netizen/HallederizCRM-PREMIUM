...
export const MSG_APPROVAL_PROCESS_DONE = "İşlem kaydı işlendi.";

export const MSG_APPROVAL_PROCESS_FAILED = "İşlem işlenemedi. Kayıt inceleme durumunda kaldı.";

export const MSG_APPROVAL_ACTION_FAILED = "İşlem tamamlanamadı.";

export const MSG_APPROVAL_LIST_FAILED = "Onay listesi şu an yüklenemedi. Lütfen daha sonra tekrar deneyin.";

export const MSG_APPROVAL_DETAIL_FAILED = "Onay detayı yüklenemedi.";

export const MSG_APPROVAL_EMPTY_LIST = "Bekleyen onay bulunmuyor.";

export const MSG_APPROVAL_EMPTY_FILTERED = "Filtreye uygun onay yok";

export const MSG_APPROVAL_EMPTY_FILTERED_HINT = "Görünüm veya filtre kriterlerini değiştirin.";
