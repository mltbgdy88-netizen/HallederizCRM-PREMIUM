...
Bu klasor proje dokumantasyonunun merkezidir.

- `master-project-spec.md`: Urun kapsaminin resmi baslangic spesifikasyonu
- `architecture.md`: Monorepo, katmanlar ve sistem davranis mimarisi
- `database-schema.md`: Kanonik veri modeli ve tablo gruplari referansi
- `module-map.md`: Ana menu, sayfa haritasi ve modul akislari
